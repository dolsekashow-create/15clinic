...
import { AppError, canAccessBranch, type AccessContext, type BaseEntity, type PageRequest, type Paginated } from '@clinic/core';
import { getDb } from '@clinic/infra';
import { fromDoc, toFirestore } from './converters.js';
